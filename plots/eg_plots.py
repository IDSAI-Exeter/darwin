...
l = [('t', "projects/darwin/data/experiments/eg_%i/train/runs/train2/results.csv"%i, i) for i in [100, 500, 1000]]
l += [('a', "projects/darwin/data/experiments/eg_%i/augment_1000/runs/augment2/results.csv"%i, i) for i in [100, 500, 1000]]
