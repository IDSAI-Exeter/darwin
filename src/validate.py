...
def main(dir):
    ...
    fold = "fold_14"
    test = "raw_1"
    os.system("cd %s; python3 ../../../../lib/yolov5/val.py --data %s.yaml --weights %s/runs/augment/weights/best.pt --project validate/ --verbose --task test 2> %sresults/%s_%s.out;cd .."%(dir+fold, test, test, dir, fold, test))
